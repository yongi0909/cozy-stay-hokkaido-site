...
const staff = [
  {
    ...
    bio: (
      <>
        <p>
          1986年9月9日生まれ。東京都出身。上智大学経済学部卒業。<br />
          大学卒業後、三井物産株式会社に入社し、国内外の事業に携わりながらビジネス運営・事業開発の経験を積む。<br />
          2019年に独立し、スリランカにて観光チャーター事業「Sri Lanka Taxi Service」を創業。
        </p>
        <p>
          その後、2022年から日本国内において宿泊事業を開始し、沖縄・宮古島および北海道で宿泊施設の企画・運営を展開。<br />
          2025年、北海道での宿泊事業拡大のためCOZY STAY北海道株式会社を設立。現在は札幌を拠点に、北海道エリアでの宿泊施設の運営・拡大を進めている。
        </p>
        <p>
          学生時代からウィンタースポーツを通じて北海道を訪れる機会が多く、その自然環境や観光資源の魅力に強い関心を持つ。<br />
          宿泊事業を通じて北海道の魅力を国内外に発信し、地域観光の発展に貢献することを目指している。
        </p>
      </>
    ),
    hasPhoto: true,
